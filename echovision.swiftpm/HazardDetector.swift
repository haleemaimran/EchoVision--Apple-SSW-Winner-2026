...
class HazardDetectorInput : MLFeatureProvider {
...
@available(macOS 11.0, iOS 14.0, tvOS 14.0, visionOS 1.0, *)
@available(watchOS, unavailable)
class HazardDetectorOutput : MLFeatureProvider {
...
class HazardDetector {
    ...
    class var urlOfModelInThisBundle : URL {
        ...
        return bundle.url(forResource: "HazardDetector", withExtension:"mlmodelc")!
    }

    /**
        Construct HazardDetector instance with an existing MLModel object.

        Usually the application does not use this initializer unless it makes a subclass of HazardDetector.
        Such application may want to use `MLModel(contentsOfURL:configuration:)` and `HazardDetector.urlOfModelInThisBundle` to create a MLModel object to pass-in.
    ...
    */
    ...
    /**
        Construct HazardDetector instance with explicit path to mlmodelc file
        - parameters:
    ...
    */
    ...
    /**
        Construct HazardDetector instance asynchronously with optional configuration.
    ...
    */
    class func load(configuration: MLModelConfiguration = MLModelConfiguration(), completionHandler handler: @escaping (Swift.Result<HazardDetector, Error>) -> Void) {
    ...
    */
    @available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, visionOS 1.0, *)
    class func load(configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> HazardDetector {
        try await load(contentsOf: self.urlOfModelInThisBundle, configuration: configuration)
    }

    /**
        Construct HazardDetector instance asynchronously with URL of the .mlmodelc directory with optional configuration.
        ...
        - parameters:
          ...
          - handler: the completion handler to be called when the model loading completes successfully or unsuccessfully
    */
    class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration(), completionHandler handler: @escaping (Swift.Result<HazardDetector, Error>) -> Void) {
        MLModel.load(contentsOf: modelURL, configuration: configuration) { result in
            switch result {
            case .failure(let error):
                handler(.failure(error))
            case .success(let model):
                handler(.success(HazardDetector(model: model)))
            }
        }
    }
    ...
    */
    @available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, visionOS 1.0, *)
    class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> HazardDetector {
        let model = try await MLModel.load(contentsOf: modelURL, configuration: configuration)
        return HazardDetector(model: model)
    }
    ...
    /**
        ...
        - parameters:
           - input: the input to the prediction as HazardDetectorInput

        - throws: an NSError object that describes the problem

        - returns: the result of the prediction as HazardDetectorOutput
    */
    func prediction(input: HazardDetectorInput) throws -> HazardDetectorOutput {
    ...
    /**
        ...
        - returns: the result of the prediction as HazardDetectorOutput
    */
    func prediction(input: HazardDetectorInput, options: MLPredictionOptions) throws -> HazardDetectorOutput {
        let outFeatures = try model.prediction(from: input, options: options)
        return HazardDetectorOutput(features: outFeatures)
    }
    ...
    */
    ...
    func prediction(input: HazardDetectorInput, options: MLPredictionOptions = MLPredictionOptions()) async throws -> HazardDetectorOutput {
    ...
    /**
        ...
        - returns: the result of the prediction as HazardDetectorOutput
    */
    func prediction(image: CVPixelBuffer, iouThreshold: Double?, confidenceThreshold: Double?) throws -> HazardDetectorOutput {
        let input_ = HazardDetectorInput(image: image, iouThreshold: iouThreshold, confidenceThreshold: confidenceThreshold)
    ...
    /**
        ...
        - parameters:
           - inputs: the inputs to the prediction as [HazardDetectorInput]
           - options: prediction options
        ...
        - returns: the result of the prediction as [HazardDetectorOutput]
    */
    func predictions(inputs: [HazardDetectorInput], options: MLPredictionOptions = MLPredictionOptions()) throws -> [HazardDetectorOutput] {
        let batchIn = MLArrayBatchProvider(array: inputs)
        let batchOut = try model.predictions(from: batchIn, options: options)
        var results : [HazardDetectorOutput] = []
        results.reserveCapacity(inputs.count)
        for i in 0..<batchOut.count {
            let outProvider = batchOut.features(at: i)
            let result =  HazardDetectorOutput(features: outProvider)
